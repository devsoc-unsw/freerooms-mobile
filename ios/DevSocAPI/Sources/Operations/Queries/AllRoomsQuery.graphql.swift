...
nonisolated public struct AllRoomsQuery: GraphQLQuery {
  public static let operationName: String = "AllRooms"
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"query AllRooms { rooms { __typename abbr accessibility audiovisual buildingId capacity floor id infotechnology lat long microphone name school seating service usage writingMedia } }"#
    ))
